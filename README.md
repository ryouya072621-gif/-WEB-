...
# デプロイ完了後、URLが表示されます
# 例: https://webapp-xxxxx-an.a.run.app
```
...
```bash
# サービスの状態を確認
gcloud run services describe webapp --region asia-northeast1

# ログを確認
gcloud run services logs read webapp --region asia-northeast1
```
